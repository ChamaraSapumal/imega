...
const Hero = () => {
    return (
        <div className="relative pb-10 pt-24 md:pt-32 overflow-hidden">
            {/* Background element */}
            <div className="absolute -top-24 right-0 w-96 h-96 bg-orange-600/10 rounded-full blur-3xl opacity-70" />
            ...
            <div className="relative grid gap-6 grid-cols-1 lg:grid-cols-2 items-center">
                <div className="space-y-8">
                    <div className="space-y-5">
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                            Transforming ideas into <span className="text-orange-600">visual stories</span>
                        </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href="/project">
                            <Button size="lg" className="gap-2 bg-orange-600">
                ...
                <div className="relative h-full w-full min-h-[400px] rounded-lg bg-muted/20 border backdrop-blur-sm overflow-hidden hidden lg:block">
                    <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 gap-2 p-4">
                        <div className="aspect-square rounded-lg bg-gradient-to-br from-orange-600/20 to-orange-600/40 p-2 flex items-end" />
